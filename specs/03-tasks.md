...
- [ ] **T-023** 🤝 Añadir la categoría «Iluminación / energía» (id 11) a las opciones del campo «¿Qué necesitas?» de «Pido ayuda» · (RF-14) — el script solo fija las opciones al crear la encuesta, y «Pido ayuda» (id 5) ya existía: quedó con 10 de las 11 categorías. **No usar `--recrear-encuestas`:** borra la encuesta con sus publicaciones dentro. Hace falta un PUT dirigido al campo.
